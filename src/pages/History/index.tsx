...
export function History() {
    ...
    const sortedPosts = posts.slice().sort((a, b) => a.title.localeCompare(b.title))

    return (
        <div className="w-full flex flex-col gap-2">
            <h1 className="text-xl font-extrabold text-center sm:text-left">Minhas Publicações</h1>
